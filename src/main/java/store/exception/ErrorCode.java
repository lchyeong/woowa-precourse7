...
public enum ErrorCode {
    ...
    NOT_MATCH_PURCHASE_FORM("I004", "[ERROR] 올바르지 않은 형식으로 입력헀습니다. 다시 입력해 주세요."),
    ...
    NOT_FOUND_PRODUCT_NAME("P001", "[ERROR] 존재하지 않는 상품입니다. 다시 입력해 주세요."),
    LACK_OF_QUANTITY("P002", "[ERROR] 재고 수량을 초과하여 구매할 수 없습니다. 다시 입력해 주세요."),
    NO_PROMOTION("P003", "[ERROR] 현재 진행중인 프로모션이 없습니다."),
